...
[Список](https://github.com/ktbyers/netmiko) поддерживаемых платформ.
...
Параметры устройства удобно задавать в словаре, который распаковывается при создании объекта. Сами параметры 
